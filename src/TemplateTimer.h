...
public:
    ...
    bool Start(unsigned int interval,   // interval in ms
               ...
               bool once = true)       // true to call timed event only once
    {
        if( m_hTimer )
        {
            return false;
        ...
        SetCount(0);
		//original value: WT_EXECUTEINTIMERTHREAD
		//WT_EXECUTEDEFAULT	OK
		//WT_EXECUTEINIOTHREAD OK
		//WT_EXECUTEINUITHREAD OK
		//WT_EXECUTEINWAITTHREAD OK
		//WT_EXECUTEONLYONCE 
